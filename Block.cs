...
namespace MCForge
{
    public class Block
    {
        ...
        {
            if (type == op_water || type == op_lava || type == op_lair || type == lava_timer || Block.portal(type) || Block.mb(type)) return false;
        ...
        public static byte Convert(byte b)
        {
            switch (b)
            {
                ...
                case 50: return (byte)0; //Op_air - Must be cuboided / replaced
