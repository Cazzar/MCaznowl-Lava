...
namespace MCForge
{
    public class CmdInvincible : Command
    {
        ...
        public override string shortcut { get { return "invincible"; } }
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (who.invincible == true)
            {
                ...
                Player.GlobalMessageOps(p.name + " has stopped being invincible!");
            }
            else
            {
                who.invincible = true;
                Player.GlobalMessageOps(p.name + " is now invincible!");
            }
        }
        public override void Help(Player p)
        {
            Player.SendMessage(p, "/god [name] - Turns invincible mode on/off.");
