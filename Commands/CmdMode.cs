    ...
    public class CmdMode : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            else
            {
                ...
                if (p.group.Permission >= LevelPermission.Operator && message == "normal_sponge")
                {
                    b = Block.Byte("sponge");
                    return;
                }
                else if (p.group.Permission >= LevelPermission.Operator && message == "sponge")
                {
                    b = Block.Byte("lava_sponge");
                    return;
                }
                else if (p.group.Permission <= LevelPermission.Operator && message == "lava_sponge")
                {
                    b = Block.Byte("sponge");
                    return;
                }
